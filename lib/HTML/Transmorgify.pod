...
array of callbacks and literals.
...
L<HTML::Transmorgify::FormDefault> both need to be invoked at compile time for 
E<lt>inputE<gt> tags.
...
Development of this module is hosted on github: L<http://github.com/muir/HTML--Transmorgify>.

=head1 LICENSE

Yahoo Inc may make any use of this module including publishing 
modified copies with a license of their own choosing.
